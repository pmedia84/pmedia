...
if(isset($_POST['validation'] ) && !empty($_POST['validation'])) {
	...
	if($responseData->success) {
		...
		$contactmethod = filter_var($_POST['contactmethod'],FILTER_SANITIZE_STRING);
		...
		<p><strong>Current Domain Name:</strong><br>$domainname</p>
		<p><strong>Contact Method:</strong><br>$contactmethod</p>
