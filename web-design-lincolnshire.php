...
<head>
    ...
    <title>Parrot Media : Web Design Lincolnshire</title>
    ...
    <main>
        ...
        <section class="container">
            ...
            <div class="banner">
                <h2>How We Work</h2>
                <p class="lead">We work closely with you to create the website you have always wanted. No two websites are the same! No templates are used in the creation of your custom website.</p>
            </div>
        ...
        <section class="containerfw  webdesign-examples">
            <div class="container">
                <div class="webdesign-examples-text">
                    <h2>Whatever Your Business We Have A Website For You</h2>
